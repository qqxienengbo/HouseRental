    ...
    <div>
        ...
        <div class="admin">
            ...
            <el-table-column label="操作" align="center" :min-width="100">
                <template v-slot="props">
                    <el-button type="success" size="mini" @click="shouzu(props.row)" >收租</el-button>
                </template>
            </el-table-column>
            </el-table>
        </div>
...
export default{
    ...
    methods:{
        ...
        shouzu(row){
            ...
            this.$set(this.onehorder,"unpaid",row.house.rent);
            delete this.onehorder.house;
            delete this.onehorder.user;
            delete this.onehorder.contract;
            request.post("/horder/shouzu",this.onehorder).then(res=>{
                if(res.code==='0'){
                    this.$notify({
                    title:"成功！",
                    message:"消息已发送，请等待租客缴费！",
                    type:"success"
                })
                }
                this.findBySearch();
